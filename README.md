...
~60 модулей, 6 точек интеграции с платформой, **762 unit-теста**, всё работает поверх штатных хуков dsh — без единой правки ядра.
...
pnpm vitest run     # 44 файла, 762 теста
```
