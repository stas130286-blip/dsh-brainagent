...
~60 модулей, 6 точек интеграции с платформой, **767 unit-тестов**, всё работает поверх штатных хуков dsh — без единой правки ядра.
...
pnpm vitest run     # 45 файлов, 767 тестов
```
