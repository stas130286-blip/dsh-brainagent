...
~60 модулей, 6 точек интеграции с платформой, **622 unit-теста**, всё работает поверх штатных хуков dsh — без единой правки ядра.
...
pnpm vitest run     # 30 файлов, 622 теста
```
...
~60 modules, 6 platform integration points, **622 unit tests**, running entirely on stock dsh hooks — zero core changes.
...
**Tests**: `pnpm vitest run` — 30 files, 622 tests
