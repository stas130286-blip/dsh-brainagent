...
~60 модулей, 6 точек интеграции с платформой, **873 unit-теста**, всё работает поверх штатных хуков dsh без единого исключения: анти-спам-пейсинг гол-раундов встроен в сам плагин, патчить хост не нужно. Установка — одна команда, без сборки и разрешений на скрипты.
...
pnpm vitest run     # 59 файлов, 873 теста
```
...
~60 modules, 6 platform integration points, **873 unit tests**, running entirely on stock dsh hooks — zero core changes.
...
**Tests**: `pnpm vitest run` — 59 files, 873 tests
