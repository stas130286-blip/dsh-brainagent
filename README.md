...
~60 модулей, 6 точек интеграции с платформой, **782 unit-теста**, всё работает поверх штатных хуков dsh — без единой правки ядра.
...
pnpm vitest run     # 48 файлов, 782 теста
```
