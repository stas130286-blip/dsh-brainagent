...
~60 модулей, 6 точек интеграции с платформой, **758 unit-тестов**, всё работает поверх штатных хуков dsh — без единой правки ядра.
...
pnpm vitest run     # 43 файла, 758 тестов
```
