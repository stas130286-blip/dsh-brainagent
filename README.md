...
~60 модулей, 6 точек интеграции с платформой, **770 unit-тестов**, всё работает поверх штатных хуков dsh — без единой правки ядра.
...
pnpm vitest run     # 46 файлов, 770 тестов
```
