...
~60 модулей, 6 точек интеграции с платформой, **862 unit-тестов**, всё работает поверх штатных хуков dsh без единого исключения: анти-спам-пейсинг гол-раундов встроен в сам плагин, патчить хост не нужно. Установка — одна команда, без сборки и разрешений на скрипты.
...
pnpm vitest run     # 58 файлов, 862 тестов
```
...
~60 modules, 6 platform integration points, **862 unit tests**, running entirely on stock dsh hooks — zero core changes.
...
**Tests**: `pnpm vitest run` — 57 files, 862 tests
