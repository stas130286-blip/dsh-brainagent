...
~60 модулей, 6 точек интеграции с платформой, **886 unit-тестов**, всё работает поверх штатных хуков dsh без единого исключения: анти-спам-пейсинг гол-раундов встроен в сам плагин, патчить хост не нужно. Установка — одна команда, без сборки и разрешений на скрипты.
...
pnpm vitest run     # 61 файл, 886 тестов
```
...
~60 modules, 6 platform integration points, **886 unit tests**, running entirely on stock dsh hooks — zero core changes.
...
**Tests**: `pnpm vitest run` — 61 files, 886 tests
