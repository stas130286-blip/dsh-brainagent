...
~60 модулей, 6 точек интеграции с платформой, **601 unit-тест**, всё работает поверх штатных хуков dsh — без единой правки ядра.
...
pnpm vitest run     # 26 файлов, 601 тест
```
...
~60 modules, 6 platform integration points, **601 unit tests**, running entirely on stock dsh hooks — zero core changes.
...
**Tests**: `pnpm vitest run` — 26 files, 601 tests
