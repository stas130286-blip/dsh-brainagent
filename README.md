...
~60 модулей, 6 точек интеграции с платформой, **776 unit-тестов**, всё работает поверх штатных хуков dsh — без единой правки ядра.
...
pnpm vitest run     # 47 файлов, 776 тестов
```
