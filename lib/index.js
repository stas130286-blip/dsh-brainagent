...
var GOAL_INTENT_PATTERN = /планирую|запланир|моя цель|мои цели|поставь цель|надо не забыть|не забудь|напомни мне|хочу успеть|задачи на (?:неделю|сегодня|завтра)|\bgoal\b|\bplan\b|\btodo\b|remind me/i;
